...
import { usePlatformSearch, type DouyinTag, type PlatformSearchForm } from '@/composables/usePlatformSearch'
import { useBatchSetApply } from '@/composables/useBatchSetApply'
import { mergeConfig } from '@/composables/useConfigMerge'
...
// ========== 平台搜索域（合集/位置/活动/热点/标签/小说）==========
// PublishCenter 拆分 #9：搜索/选择逻辑收敛到 usePlatformSearch composable（纯搬移，行为不变）
const {
  ...
  form: form as unknown as PlatformSearchForm,
  selectedAccountId,
  accountStore,
})
