...
const { applyImageBatchSet } = useImageBatchSetApply({ panels: Object.values(panelsProxy) as unknown as import('@/composables/useImageBatchSetApply').BatchPanelIndex, accountStore })
