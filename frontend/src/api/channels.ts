...
export const channelsApi = {
  ...
  getCollections(accountId: string | number | null) {
  ...
  getLocations(accountId: string | number | null, keyword: string) {
  ...
  searchActivities(accountId: string | number | null, keyword: string) {
